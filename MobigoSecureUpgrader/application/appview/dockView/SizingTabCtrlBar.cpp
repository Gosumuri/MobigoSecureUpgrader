...
IMPLEMENT_DYNAMIC( CSizingTabCtrlBar, CSizingControlBar )
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f? Nachrichten CSizingTabCtrlBar 
...
//	m_images.Create(IDB_TAB_ICON, 16, 1, RGB(255,0,255));
//	m_tabctrl.SetImageList(&m_images);
	
	// 2. set "normal" GUI-font
...
void CSizingTabCtrlBar::MoveView( int cx, int cy) 
{
...
// 20031007_02 : jkim
//	- SizingTabCtrlBar이 닫힐 때, MainFrame이 message를 못받는 문제 해결
//    ( 참조 : http://www.codeproject.com/docking/sizing_tabctl.asp#xx241981xx )
